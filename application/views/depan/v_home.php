...
<div class="slider_area">
  <div class="slider_active owl-carousel">
    <!-- single_carouse -->
    <div class="single_slider  d-flex align-items-center jumbotron jumbotron-fluid" id="karosel">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            <div class="slider_text ">
              <h1 class=" text-center text-white" id="text-home">SMP NEGERI 1 PEMALANG </h1>
              <h2 class="text-center text-white" id="text-home1">" Berkarakter Positif, Berprestasi Optimal, dan Cinta Lingkungan Hidup "</h2>
              <img src="<?php echo base_url(''); ?>style/img/logosmp1.png" alt="" id="logosmp1">
            </div>
          </div>
        </div>
      </div>

      ...
      <div class="row">
        <div class="col-xl-3 col-md-6 col-lg-3">
          <div class="footer_widget">
            ...
            <img width="150" src="<?php echo base_url(''); ?>style/img/logosmp1.png" class="rounded" alt="Muris Studio">
          </div>
        </div>
        <div class="col-xl-3 col-md-6 col-lg-3">
          <div class="footer_widget">
          ...
          <div class="footer_widget">
            ...
            <div class="media contact-info">
              ...
              <div class="media-body">
                <p>SMP Negeri 1 Pemalang</p>
              </div>
            </div>
            <div class="media contact-info">
              <span class="contact-info__icon"><i class="ti-tablet"></i></span>
              <div class="media-body">
                <p>Call : (0284) 321171</p>
              </div>
            </div>
            <div class="media contact-info">
              <span class="contact-info__icon"><i class="ti-email"></i></span>
              <div class="media-body">
                <p>smpn1pemalang@gmail.com</p>
              </div>
            </div>
            <div class="media contact-info">
              <span class="contact-info__icon"><i class="ti-facebook"></i></span>
              <div class="media-body">
                <p>@smpnegeri1pemalang</p>
              </div>
            </div>
            <div class="media contact-info">
      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <p>
            ...
            </script> <a href="#" target="_blank">SMP Negeri 1 Pemalang</a>
          </p>
          </p>
        </div>
      </div>

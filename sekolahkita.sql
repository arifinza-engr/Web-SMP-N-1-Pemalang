...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2468911672ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_mapel">`sekolahkita`.`tbl_mapel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_files">`sekolahkita`.`tbl_files`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_guru">`sekolahkita`.`tbl_guru`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_komentar">`sekolahkita`.`tbl_komentar`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_tulisan">`sekolahkita`.`tbl_tulisan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_video">`sekolahkita`.`tbl_video`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_kelas">`sekolahkita`.`tbl_kelas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_pengguna">`sekolahkita`.`tbl_pengguna`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sekolahkita&table=tbl_galeri">`sekolahkita`.`tbl_galeri`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=petugas">`apotek`.`petugas`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="30642255715c63465460224e582e7c25">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="apotek" targettable="petugas">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `petugas`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_pengguna">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_pengguna`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_pengguna">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_pengguna`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_galeri">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_galeri`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_pengguna">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_pengguna`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_kelas">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_kelas`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_kelas">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_kelas`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_komentar">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_komentar`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_mapel">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_mapel`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_video">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_video`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_tulisan">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_tulisan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_komentar">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_komentar`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_guru">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_guru`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_files">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_files`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sekolahkita" targettable="tbl_mapel">
                            <div class="action_content">
